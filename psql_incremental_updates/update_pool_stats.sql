...
CREATE TABLE IF NOT EXISTS public.pool_stats_summary
(
    epoch_no word31type NOT NULL,
    pool_id bigint NOT NULL,
    pool_view text COLLATE pg_catalog."default",
    total_stake numeric(20,5) NOT NULL,
    delegator_count bigint NOT NULL,
    pledge lovelace,
    is_active boolean NOT NULL,
    saturation_ratio numeric(20,10),
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT pool_stats_summary_pkey PRIMARY KEY (epoch_no, pool_id)
);
