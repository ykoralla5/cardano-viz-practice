                ...
                {selectedElement && selectedElementData && (
                    <div className="w-[25vw] absolute left-5 top-15 bg-white p-5 opacity-95 shadow-lg outline outline-black/5 dark:bg-slate-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10 text-base rounded-md wrap-anywhere text-gray-400 dark:text-gray-400">
                        ...
                        <div className="overflow-y-auto max-h-[57.5vh] py-3">
                            {type === "pool" && (
                                <>
                                    <p className="text-base font-bold text-gray-900 dark:text-gray-300">Metadata</p>
                                    ...
                                    <p className="text-base font-bold text-gray-900 dark:text-gray-300">Stake and delegation data for epoch</p>
                                    <hr className="my-1.5 text-gray-400"/>
                                    ...
                                    <p className="text-base font-bold text-gray-900 dark:text-gray-300">Performance data for epoch</p>
                                    <hr className="my-1.5 text-gray-400"/>
