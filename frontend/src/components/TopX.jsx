                        ...
                        <table className="min-w-full border border-gray-300 dark:border-gray-600">
                            <thead>
                                <tr className="text-left text-gray-700 dark:text-gray-300">
                                    {/* <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 w-20 flex items-center" onClick={() => requestSort("rank")}>
                                        <span className="flex flex-col">Rank<span className="text-tiny">(by total stake)</span></span>
                                    ...
                                    <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 whitespace-nowrap w-25" onClick={() => requestSort("total_stake")}><span className="flex gap-2">Active stake <SortIcon  columnKey="total_stake" /></span></th>
                                    <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 whitespace-nowrap w-25" onClick={() => requestSort("input_stake")}><span className="flex gap-2">Input stake <SortIcon columnKey="input_stake" /></span></th>
                                    <th className="border border-gray-300 dark:border-gray-600 px-2 py-1 whitespace-nowrap w-25" onClick={() => requestSort("output_stake")}>
                                        <span className="flex gap-2">Output stake <SortIcon columnKey="output_stake" /></span></th>
                                </tr>
                            </thead>
                            <tbody>
