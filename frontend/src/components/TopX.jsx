...
export default function TopX({ isOpen, onClose, selectedElement, setSelectedElement, nodes }) {
    ...
    return (
        <>
            {isOpen && (
                <div className="w-[30vw] absolute right-5 top-15 bg-white p-5 opacity-95 shadow-lg outline outline-black/5 dark:bg-slate-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10 text-sm rounded-md wrap-anywhere text-gray-400 dark:text-gray-400 overflow-y-scroll max-h-[65vh]">
                        ...
                        <table className="min-w-full border border-gray-300 dark:border-gray-600">
                            <thead>
                                <tr className="text-left text-gray-700 dark:text-gray-300">
                                    ...
                                    <th className="border border-gray-300 dark:border-gray-600 px-2 py-1">Active Stake</th>
                                </tr>
                            </thead>
                            <tbody>
