                    ...
                    {delegationTypes.map(type => (
                        <label className="inline-flex items-center cursor-pointer" key={type}>
                            <input type="checkbox" value={type} className="sr-only peer"
                                checked={selectedDelTypes.includes(type)} onChange={handleFilterChange(type)} />
                ...
                <div className="flex-grow overflow-x-hidden overflow-y-auto">
                    {filteredData.length === 0 ? (
                        ...
                        <table className="min-w-full border border-gray-300 dark:border-gray-600">
                            <thead>
                                <tr>
                                    <th onClick={() => requestSort("date")} className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-left w-25"><span className="flex gap-2">Date <SortIcon columnKey="date" /></span></th>
                                    ...
                                    <th onClick={() => requestSort("amount")} className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-left whitespace-nowrap"><span className="flex gap-2">Amount (₳) <SortIcon columnKey="amount" /></span></th>
                                    <th onClick={() => requestSort("type")} className="border border-gray-300 dark:border-gray-600 px-2 py-1 text-left"><span className="flex gap-2">Type <SortIcon columnKey="type" /></span></th>
                                </tr>
                            </thead>
                            <tbody>
